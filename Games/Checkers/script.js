        ...
        React.createElement('div', {
            ...
            gameState.gameStatus !== 'playing' && React.createElement('div', {
                ...
                React.createElement('p', {
                        className: "text-yellow-800 dark:text-yellow-200 font-medium text-center"
                    },
...
const GameBoard = ({
    ...
    return React.createElement('div', {
            className: "lg:order-2 lg:col-span-2 flex justify-center"
        },
        React.createElement('div', {
                className: "bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700"
            },
            React.createElement('div', {
                    className: "grid grid-cols-8 gap-1 w-full max-w-md lg:max-w-lg mx-auto aspect-square bg-amber-900 dark:bg-amber-800 p-2 rounded-xl"
                },
                Array.from({
                        length: BOARD_SIZE
                    }, (_, row) =>
        ...
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        className: "w-3 h-3 rounded-full bg-gradient-to-r from-red-400 to-red-600 mt-1 flex-shrink-0"
                    }),
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        className: "w-3 h-3 rounded-full bg-gradient-to-r from-blue-400 to-blue-600 mt-1 flex-shrink-0"
                    }),
                ...
                React.createElement('div', {
                    ...
                    React.createElement('div', {
                        className: "w-3 h-3 rounded-full bg-yellow-400 mt-1 flex-shrink-0"
                    }),
...
const CheckersGame = () => {
    ...
    const handleSquareClick = useCallback((row, col) => {
        ...
        if (clickedPiece && clickedPiece.player === gameState.currentPlayer) {
            const validMoves = getValidMoves(clickedPiece, {
                row,
                col
            }, gameState.board);
        ...
        const hasMoreJumps = capturedPositions.length > 0 &&
            getValidMoves(newBoard[row][col], {
                row,
                col
            }, newBoard)
    ...
    return React.createElement('div', {
            className: "min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 dark:from-gray-900 dark:to-slate-800 transition-colors duration-300"
        },
        React.createElement('div', {
            ...
            React.createElement('div', {
                ...
                React.createElement('div', {
                    ...
                    React.createElement('h1', {
                        className: "text-3xl lg:text-4xl font-bold text-gray-800 dark:text-white mb-2"
                    }, "Checkers"),
                    React.createElement('p', {
                        className: "text-gray-600 dark:text-gray-300 text-sm lg:text-base"
                    }, "Classic strategy game")
                ),
                React.createElement(ThemeToggle)
            ),
            React.createElement('div', {
                    className: "grid grid-cols-1 lg:grid-cols-4 gap-6 lg:gap-8 max-w-7xl mx-auto"
                },
