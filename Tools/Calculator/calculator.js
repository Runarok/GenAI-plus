    ...
    <div className="calculator-container">
      <div className="calculator">
        ...
        <div className="button-row">
          <button className={`btn btn-function ${angleMode === "RAD" ? "active-mode" : ""}`} onClick={toggleAngleMode}>
            RAD
          </button>
          <button className={`btn btn-function ${angleMode === "DEG" ? "active-mode" : ""}`} onClick={toggleAngleMode}>
            DEG
          </button>
